...
Modified by Mariano Semelman in 2011
...
class V2d(object):
    ...
    def set_pos(self, pos):
        "Builds itself from a pair. "
        self._initialize(pos, None)

    pos = property(get_pos, set_pos)

    def get_int_pos(self):
        """ Build int tuple from this vector. """
    ...
    def set_length(self, length):
        ...
        if actual_length:
            self.x /= actual_length
            self.y /= actual_length
        self.x *= length
        self.y *= length
